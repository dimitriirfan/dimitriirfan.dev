import { calcAverageScore, findMax, findMin } from "../tools/calcProjects";

describe('score calculations', () => {
    test('expecting exact average', () => {
        const val = [80, 100, 100, 80]
        expect(calcAverageScore(val)).toEqual(90)
    })
